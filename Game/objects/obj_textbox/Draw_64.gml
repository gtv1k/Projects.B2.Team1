...
if(portrait[page] != -1){
	...
	//draw_sprite_stretched(portrait[page],0,pos_x-100,pos_y-75,150,150)
...
//	draw_sprite_stretched(portrait[page],0,pos_x-100,pos_y-75,150,150)
	draw_sprite_ext(portrait[page], image_index, pos_x-100, pos_y-78, 0.1, 0.1, image_angle, image_blend, image_alpha);
